...
export default function SectionModal( { section, collectionId, onSave, onClose } ) {
  ...
  if ( isLoading ) {
    return (
      <Modal
        title={ isEditing ? __( 'Edit section', 'richie' ) : __( 'Add section', 'richie' ) }
  ...
  return (
    ...
    >
      <div className="section-modal-content">
        ...
        <div className="section-modal-row section-modal-row--two-col">
          <div className="section-modal-field">
            <NumberControl
              ...
              onChange={ ( value ) => updateField( 'number_of_posts', parseInt( value, 10 ) ) }
              __next40pxDefaultSize
              min={ 1 }
              max={ 50 }
            />
          ...
          <SelectControl
            ...
            onChange={ ( value ) => updateField( 'list_layout_style', value ) }
            __next40pxDefaultSize
            __nextHasNoMarginBottom
          />
        </div>
        ...
        <div className="section-modal-row section-modal-row--two-col">
          ...
          <SelectControl
            ...
            onChange={ ( value ) => updateField( 'order_direction', value ) }
            __next40pxDefaultSize
            __nextHasNoMarginBottom
          />
        </div>
        ...
        <div className="section-modal-row">
          <label className="components-base-control__label">{ __( 'Categories', 'richie' ) }</label>
        ...
        <div className="section-modal-row">
          <TextControl
            ...
            __next40pxDefaultSize
            __nextHasNoMarginBottom
            help={ __( 'Enter tag slugs separated by commas', 'richie' ) }
          />
        </div>
        ...
        <div className="section-modal-row">
          <TextControl
            ...
            onChange={ ( value ) => updateField( 'list_group_title', value ) }
            __next40pxDefaultSize
            __nextHasNoMarginBottom
            help={ __(
        ...
        <div className="section-modal-row section-modal-row--color">
          ...
          <div className="section-modal-color-picker">
            ...
            { isColorPickerOpen && (
              <Popover placement="bottom-start" onClose={ () => setIsColorPickerOpen( false ) }>
                <ColorPicker
                  color={
                    formData.background_color ? `#${ formData.background_color }` : undefined
                  }
                  onChangeComplete={ ( value ) => handleBackgroundColorChange( value.hex ) }
                  disableAlpha
                />
              </Popover>
            ) }
        ...
        <div className="section-modal-row section-modal-row--checkboxes">
          <div className="section-modal-field">
            <CheckboxControl
              ...
              onChange={ ( value ) => updateField( 'allow_duplicates', value ) }
              __nextHasNoMarginBottom
            />
            <p className="section-modal-help">
          ...
          <div className="section-modal-field">
            <CheckboxControl
              ...
              onChange={ ( value ) => updateField( 'disable_summary', value ) }
              __nextHasNoMarginBottom
            />
            <p className="section-modal-help">
      ...
      <div className="modal-footer section-modal-footer">
        ...
        >
          { isEditing ? __( 'Update section', 'richie' ) : __( 'Add section', 'richie' ) }
        </Button>
      </div>
    </Modal>
  );
