<?php
/**
 * Service for handling Maggio issues
 *
...
class Richie_Maggio_Service {
     ...
     *
     * @var Richie_Cached_Request
     */
    private $cached_request;

    /**
     * Create a new Maggio Service instance
     *
     ...
     *
     * @param string  $organization Maggio organization.
     * @param string  $product Maggio product.
