...
* @subpackage Richie_News_Feed/admin
*/
...
class Richie_News_Feed_Admin {
    ...
    */
    public function enqueue_styles() {
        ...
        */
        ...
        wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/richie-news-feed-admin.css', array(), $this->version, 'all' );
    ...
    */
    public function enqueue_scripts() {
        ...
        */
        ...
        wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/richie-news-feed-admin.js', array( 'jquery' ), $this->version, false );
    ...
    */
    ...
    public function load_admin_page_content() {
        require_once plugin_dir_path( __FILE__ ). 'partials/richie-news-feed-admin-display.php';
    }
